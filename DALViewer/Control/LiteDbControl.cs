...
namespace UtilityDAL.View
{
    ...
    .Ignore(x => x.Deletions) // ignore this property (do not store)
      .Ignore(x => x.DeleteCommand);
        ...
        private static string GetDirectory =>
            UtilityDAL.DbEx.GetDirectory("../../data", UtilityDAL.Constants.LiteDbExtension, typeof(SHDOObject));
    ...
    public class LiteDbControl<T> : DocumentStoreControl where T : new()
    {
        ...
        => new LiteDbRepo<SHDOObject, IConvertible>(_ => (IConvertible)getKey(_), UtilityDAL.DbEx.GetDirectory<T>(directory, UtilityDAL.Constants.LiteDbExtension));
