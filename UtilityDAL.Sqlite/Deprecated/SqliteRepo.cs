...
//        public bool TransferToDB2<T, R>(IEnumerable<T> items, bool check, params string[] children) where T : DatabaseRow, IEquatable<T>, new() where R : IChildRow<DatabaseRow>
//        {
//            _conn.CreateTable<T>();
//            var accessors = children.Select(child =>
//            {
...
//        public bool TransferToDB2<T>(IEnumerable<T> items, bool check) where T : DatabaseRow, IEquatable<T>, new()
//        {
//            _conn.CreateTable<T>();
